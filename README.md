...
这是一个可直接部署到 GitHub Pages 的静态网站，用于展示 2026 年 5 月 15 日至 17 日公司阳朔团建的集合、交通、行程、安全、物品清单和组长执行清单。
...
当前版本面向 GitHub Pages 发布，默认不展示订单号、座位号、导游联系方式和各组组长联系方式。完整联系方式请保留在公司邮件或微信群中；如果网站只发布在私有仓库或内部网络，可以再把联系人信息替换为完整号码。
